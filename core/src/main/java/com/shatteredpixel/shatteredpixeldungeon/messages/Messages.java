...
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.npcs.CheatCodeManager;
import com.shatteredpixel.shatteredpixeldungeon.messages.CheatMessages;
...
public class Messages {
	...
	public static String get(Class c, String k, Object...args){
		...
		// Gestion des messages de triche
		if (c == CheatCodeManager.class) {
			switch (k) {
				case "cheats_enabled": return CheatMessages.CHEATS_ENABLED;
				case "cheats_disabled": return CheatMessages.CHEATS_DISABLED;
				case "cheats_reset": return CheatMessages.CHEATS_RESET;
				case "cheat_activated": return format(CheatMessages.CHEAT_ACTIVATED, args);
				case "god_mode": return CheatMessages.GOD_MODE;
				case "all_weapons": return CheatMessages.ALL_WEAPONS;
				case "infinite_gold": return CheatMessages.INFINITE_GOLD;
				case "full_heal": return CheatMessages.FULL_HEAL;
				case "level_up": return format(CheatMessages.LEVEL_UP, args);
				case "max_level": return CheatMessages.MAX_LEVEL;
				case "map_revealed": return CheatMessages.MAP_REVEALED;
				case "all_enemies_killed": return format(CheatMessages.ALL_ENEMIES_KILLED, args);
				case "flight_on": return CheatMessages.FLIGHT_ON;
				case "flight_off": return CheatMessages.FLIGHT_OFF;
				case "noclip_on": return CheatMessages.NOCLIP_ON;
				case "noclip_off": return CheatMessages.NOCLIP_OFF;
				case "speed_boost": return CheatMessages.SPEED_BOOST;
				case "everything_given": return CheatMessages.EVERYTHING_GIVEN;
				case "teleport_enabled": return CheatMessages.TELEPORT_ENABLED;
				case "xray_enabled": return CheatMessages.XRAY_ENABLED;
				case "super_powers": return CheatMessages.SUPER_POWERS;
				case "legendary_sword_obtained": return CheatMessages.LEGENDARY_SWORD_OBTAINED;
				case "fire_sword_obtained": return CheatMessages.FIRE_SWORD_OBTAINED;
				case "weapon_error": return CheatMessages.WEAPON_ERROR;
			}
		}
